...
<!--        <div label="朝代">-->
        ...
        <div>
          ...
          <el-radio v-model="searchForm.v_4" label="Freersackler">史密斯博物馆</el-radio>
          <el-radio v-model="searchForm.v_4" label="Denver Art Museum">波士顿美术馆</el-radio>
          <el-radio v-model="searchForm.v_4" label="Rubin Museum">哈佛大学博物馆</el-radio>
...
export default {
  ...
  created () {
    this.searchForm.infro = this.$route.params.infro
    // this.$route.query.key
  },
  methods: {
    onSubmit_to_search () {
      if (this.searchForm.v_3 === '' || this.searchForm.v_2 === '' || this.searchForm.v_1 === '' || this.searchForm.v_4 === '') { alert('请将四种分类选择完整') } else {
        axios.post('http://localhost:8085/search/multiFind', this.searchForm
        ).then((response) => {
