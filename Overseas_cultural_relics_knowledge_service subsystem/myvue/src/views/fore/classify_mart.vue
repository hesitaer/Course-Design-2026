    ...
    <div class="filter-page">
      <div v-if="flag" class="filter-container">
        <div class="filter-header">
          <h2 class="filter-title">选择材质</h2>
          <p class="filter-desc">浏览不同材质的珍贵文物</p>
        </div>
        
        <div class="filter-card">
          <div class="radio-grid">
            <el-radio v-model="searchForm.v_2" label="porcelain">瓷器</el-radio>
            <el-radio v-model="searchForm.v_2" label="stoneware">炻器</el-radio>
            <el-radio v-model="searchForm.v_2" label="jade">玉器</el-radio>
            <el-radio v-model="searchForm.v_2" label="silk">丝绸</el-radio>
            <el-radio v-model="searchForm.v_2" label="bronze">青铜</el-radio>
            <el-radio v-model="searchForm.v_2" label="paper">纸本</el-radio>
          </div>
...
export default {
  ...
  methods: {
    ...
    onSubmit_to_search () {
      if (this.searchForm.v_2 === '') { 
        alert('请选择材质') 
      } else {
        console.log('发送请求:', JSON.stringify(this.searchForm))
