    ...
    <div class="filter-page">
      <div v-if="flag" class="filter-container">
        <div class="filter-header">
          <h2 class="filter-title">选择类型</h2>
          <p class="filter-desc">浏览不同类型的珍贵文物</p>
        </div>
        
        <div class="filter-card">
          <div class="radio-grid">
            <el-radio v-model="searchForm.v_3" label="Ceramics">陶瓷</el-radio>
            <el-radio v-model="searchForm.v_3" label="Paintings">绘画</el-radio>
            <el-radio v-model="searchForm.v_3" label="Ritual Implements">礼器</el-radio>
            <el-radio v-model="searchForm.v_3" label="Sculpture">雕塑</el-radio>
            <el-radio v-model="searchForm.v_3" label="Prints">版画</el-radio>
            <el-radio v-model="searchForm.v_3" label="Textiles">织绣</el-radio>
            <el-radio v-model="searchForm.v_3" label="Tools & Weapons">兵器工具</el-radio>
            <el-radio v-model="searchForm.v_3" label="Jewelry & Ornaments">珠宝饰品</el-radio>
            <el-radio v-model="searchForm.v_3" label="Drawings">素描</el-radio>
            <el-radio v-model="searchForm.v_3" label="Books & Calligraphy">书画</el-radio>
          </div>
